...
import VisualPrayerCountdown from "../components/VisualPrayerCountdown";
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.langSwitchContainer}>
        <TouchableOpacity onPress={toggleLanguage} style={styles.langButton}>
          <Text style={styles.langText}>
            {language === "en" ? "Arabic (عربي)" : "English"}
          </Text>
        </TouchableOpacity>
      </View>
      ...
      >
            ...
            <View style={[styles.bannerRow, isRTL && styles.rtlDirection]}>
              <Text style={styles.bannerTime}>
                ...
                {(() => {
                  ...
                  return formatRemainingTime(target - new Date(), t);
                })()}
              </Text>
            </View>
          </View>
        ...
        {/* Visual Prayer Countdown */}
        {nextPrayer && (
          <VisualPrayerCountdown
        ...
        {error && (
          <View style={styles.errorContainer}>
            ...
            <Text style={styles.retryText} onPress={refreshParams}>
              {t("retry")}
            </Text>
          </View>
        )}
...
const styles = StyleSheet.create({
  ...
  testAlarmButton: {
    backgroundColor: "#FF5722", // Orange color for test button
